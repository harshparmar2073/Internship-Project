...
import { Box, Typography, Button, Grid, Avatar, Link, Container, List, ListItem, ListItemText, useMediaQuery, useTheme } from '@mui/material';
...
const WhoShouldSellContainer = styled(Box)(({ theme }) => ({
    ...
    marginBottom: "-80px", // Use negative margin to pull up the next section
    zIndex: 2,
    [theme.breakpoints.down("sm")]: {
      marginBottom: "-50px", // Adjust for small screens
      padding: "2rem 1.5rem",
    },
  }));
...
const BuyerHub = () => {
  ...
  spacing={3}
  justifyContent="space-between"
  sx={{ paddingX: { xs: 2, md: 4 } }} // Added padding here
>
  {steps.map((step, index) => (
    <Grid item key={index} xs={12} sm={6} md={2.3} lg={2} sx={{ display: 'flex', justifyContent: 'center' }}>
      <StepItem>
        <Avatar
          sx={{
            bgcolor: '#f7f9fc',
      ...
      <SellingContainer>
                  <Grid container alignItems="center" spacing={4}>
                    ...
                    <Grid item xs={12} md={6}>
                      ...
                      Shop Online at your Leisure and Convenience Save Money with Options for Used and PreOwned Testing Equipment                      </Typography>
